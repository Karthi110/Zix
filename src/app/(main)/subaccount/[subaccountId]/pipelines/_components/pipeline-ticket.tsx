...
import { deleteTicket, saveActivityLogNotification } from "@/lib/queries";
      ...
      {(provided, snapshot) => {
        ...
        return (
          ...
          >
            <AlertDialog>
              <DropdownMenu>
                <Card className="my-4 dark:bg-muted bg-white shadow-none transition-all border-2 rounded-xl w-full">
