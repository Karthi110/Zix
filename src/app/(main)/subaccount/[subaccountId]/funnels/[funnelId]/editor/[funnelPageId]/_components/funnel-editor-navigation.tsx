...
import { saveActivityLogNotification, upsertFunnelPage } from "@/lib/queries";
...
const FunnelEditorNavigation = ({
  ...
  return (
    <TooltipProvider>
      <nav
        className={clsx(
          "border-b-2 rounded-md flex items-center justify-between px-4 py-2 gap-2 transition-all",
        ...
        <aside className="flex items-center gap-4 max-w-[260px] w-[300px]">
          ...
          <div className="flex flex-col w-full ">
            <Input
              ...
              className="border-none h-5 m-0 p-1 text-lg"
