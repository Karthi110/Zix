...
const FunnelSteps = ({ funnel, funnelId, pages, subaccountId }: Props) => {
  ...
  return (
    <AlertDialog>
      <div className="flex border-2 lg:!flex-row flex-col rounded-lg">
        <aside className="flex-[0.3] bg-background/70 p-4 flex flex-col justify-between rounded-lg ">
        ...
        <aside className="flex-[0.7] bg-muted p-2">
          {!!pages.length ? (
